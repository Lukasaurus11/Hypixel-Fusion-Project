...
export default function Footer({ lastUpdated }: FooterProps) {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 bg-gray-800 text-white py-2 border-t-2 border-gray-600 text-sm">
      <div className="w-full flex justify-between items-center px-6">
        <div className="text-left">Last updated: {formattedDate}</div>
